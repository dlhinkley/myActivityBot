...
*/
    ...
    this.getPaddingPolygon = function() {
...
/*         var polygonVertices =  [{x: 143, y: 327}, {x: 80, y: 236}, {x: 151, y: 148}, {x: 454, y: 69}, {x: 560, y: 320}]; */
        ...
        // Convert wall format into pollygonVertices format
        //
		for (var m = 0; m < walls.length(); m++ ) {
            ...
            polygonVertices.push({x: line.start.x, y: line.start.y});
            polygonVertices.push({x: line.end.x, y: line.end.y});
        }
